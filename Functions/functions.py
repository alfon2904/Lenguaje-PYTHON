...
describir_persona("pocho", 25, "gato")
describir_persona(sexo="hombre", nombre="madeval", edad=39)

# Argumentos por clave
# parámetros nombrados
describir_persona(sexo="gato", nombre="alfonso", edad=25)
...
mostrar_informacion_de(nombre="Jessica", edad=25, sexo="gato")
print("\n")
